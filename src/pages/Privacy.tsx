  ...
  return (
    <main className="pt-28 pb-20 max-w-3xl mx-auto px-6 text-on-surface">
      ...
      <section className="space-y-6 text-on-surface-variant leading-relaxed">
        <p>CINEVOID ("we", "us", "our") is committed to protecting your privacy. This Privacy Policy explains how we handle information when you visit our website at <strong className="text-on-surface">cinevoid.com</strong>.</p>
        ...
        <p>If you have questions about this policy, please contact us at <strong className="text-on-surface">privacy@cinevoid.com</strong>.</p>
      </section>
    </main>
  );
}
