...
export default function DMCA() {
  return (
    <main className="pt-28 pb-20 max-w-3xl mx-auto px-6 text-on-surface">
      <SEO title="DMCA Policy | CINEVIDEO" canonicalUrl="https://cinevoid.pages.dev/dmca" />
      ...
      <section className="space-y-6 text-on-surface-variant leading-relaxed">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>The specific URL on our site where the allegedly infringing content appears.</li>
        ...
        <h2 className="text-xl font-bold text-on-surface">Response</h2>
        <p>We will review all legitimate DMCA requests and take appropriate action (such as removing links to third-party sources) within 72 hours of receiving a valid notice.</p>
      </section>
    </main>
  );
}
